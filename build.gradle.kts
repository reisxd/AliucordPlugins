...
subprojects {
    ...
    aliucord {
        ...
        updateUrl.set("https://raw.githubusercontent.com/reisxd/AliucordPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/reisxd/AliucordPlugins/builds/%s.zip")
    }
